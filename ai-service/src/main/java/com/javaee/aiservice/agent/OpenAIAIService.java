...
public class OpenAIAIService implements AIService {
    ...
    public OpenAIAIService(String apiKey, String baseUrl, ModelType modelType, String modelAlias, boolean enabled) {
        this.apiKey = apiKey;
    ...
    public String callChat(String prompt) {
        ...
        String actualModel = (modelAlias != null && !modelAlias.isEmpty()) ? modelAlias : modelType.getCode();
        log.info("调用OpenAI兼容接口模型: {}, 实际API模型: {}, prompt长度: {}", modelType.getName(), actualModel, prompt.length());
